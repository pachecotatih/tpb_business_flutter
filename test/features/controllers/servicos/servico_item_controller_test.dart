...
void main() {
  ...
  group('ServicoItemController - save', () {
    test(
      'deve enviar POST e retornar true ao criar novo serviço (uid vazio)',
      () async {
        controller.emit(
          controller.state.copyWith(
            data: ServicoModel(uid: '', nome: 'Novo Serviço'),
          ),
        );
    ...
    test(
      'deve enviar PUT e retornar true ao editar serviço existente',
      () async {
        controller.emit(
          controller.state.copyWith(
            data: ServicoModel(
    ...
    test('deve retornar false e emitir erro interno ao receber 500', () async {
      controller.emit(controller.state.copyWith(data: ServicoModel(uid: 's1')));
